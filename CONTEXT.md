...
Статический PWA без сборки: vanilla JS + HTML/CSS. Точка входа — index.html в корне; service worker — sw.js (CACHE='yaya-v16'); карты — Leaflet 1.9.4 с CDN; геокодинг — Nominatim (OSM).
...
- sw.js — service worker: network-first кэш (CACHE='yaya-v16'), пуш-уведомления статусов заказа, обработка кликов по нотификации.
...
## 6. Готчи
- PWA: при ЛЮБОЙ правке .html бампать тег кэша в sw.js — текущий const CACHE = 'yaya-v16' (тег дословно: yaya-v16).
