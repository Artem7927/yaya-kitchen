...
Статический PWA без сборки: vanilla JS + HTML/CSS. Точка входа — index.html в корне; service worker — sw.js (CACHE='yaya-v17'); карты — Leaflet 1.9.4 с CDN; геокодинг — Nominatim (OSM).
...
- sw.js — service worker: network-first кэш (CACHE='yaya-v17'), пуш-уведомления статусов заказа, обработка кликов по нотификации.
...
## 6. Готчи
- PWA: при ЛЮБОЙ правке .html бампать тег кэша в sw.js — текущий const CACHE = 'yaya-v17' (тег дословно: yaya-v17).
